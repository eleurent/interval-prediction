...
% Subcaption must be wrapped, in IEEEtan class
\makeatletter
...
\title{Interval Prediction for Continuous-Time Systems with Parametric Uncertainties}

\author{Edouard Leurent, Denis Efimov, Tarek Ra\"issi, Wilfrid Perruquetti\thanks{Edouard Leurent is with Renault, France. 

Denis Efimov is with Inria, Univ. Lille, CNRS, UMR 9189 - CRIStAL,
F-59000 Lille, France and with ITMO University, 197101 Saint Petersburg,
Russia. 

Tarek Ra\"issi is with Conservatoire National des Arts et M\'etiers
(CNAM), Cedric 292, Rue St-Martin, 75141 Paris, France. 

Wilfrid Perruquetti is with Centrale Lille, CNRS, UMR 9189 - CRIStAL,
F-59000 Lille, France.

This work is partially supported by the Government of Russian Federation
...
\begin{figure}
\begin{centering}
\includegraphics[width=7cm]{IntFreq}
\par\end{centering}
...
\begin{figure}
\begin{centering}
%\includegraphics[width=7cm]{IP_Direct}
\includesvg[width=\linewidth]{observer}
\par\end{centering}
...
\begin{figure}
\begin{centering}
%\includegraphics[width=7cm]{IP_New}
\includesvg[width=\linewidth]{predictor}
\par\end{centering}
...
\begin{figure}[htp]
    ...
    \centering
      \includegraphics[width=\linewidth]{driving_observer.png}
      \caption{The naive predictor \eqref{eq:IP_direct} quickly diverges}
      \label{sub:hw-a}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
    \centering
      \includegraphics[width=\linewidth]{driving_predictor.png}
      \caption{The proposed predictor \eqref{eq:IP_main} remains stable}
      \label{sub:hw-b}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
    \centering
      \includegraphics[width=\linewidth]{lane_change_predictor.png}
      \caption{Prediction during a lane change maneuver}
      \label{sub:hw-c}
    \end{subfigure}
    \begin{subfigure}[b]{0.49\textwidth}
    \centering
      \includegraphics[width=\linewidth]{overtake.png}
